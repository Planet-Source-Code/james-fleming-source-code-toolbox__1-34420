...
Begin VB.Form frmReadProg 
   ...
   Begin VB.Timer Timer1 
      ...
      Top             =   1080
   End
   Begin VB.CommandButton cmdReadProg 
      Caption         =   "Cancel"
      Height          =   375
      Left            =   1185
      TabIndex        =   0
...
Dim FormTemp As frmClipboard
Private Sub cmdReadProg_Click()
    ProgressCancel = True
End Sub
Private Sub LoadFile()
 ...
 Open FileFSToOpen For Input As file1
  Do While Not EOF(file1) ' Loop until end of file.
    ...
    FormTemp.txtClipboard.Text = FormTemp.txtClipboard.Text & textline & Chr(13) & Chr(10)
